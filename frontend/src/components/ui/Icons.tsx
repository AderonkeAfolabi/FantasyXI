...
export const FootballIcon: React.FC<IconProps> = ({ size = 20, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PitchIcon: React.FC<IconProps> = ({ size = 20, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M2 10a2 2 0 0 1 2-2h1v8H4a2 2 0 0 1-2-2Z" />
    <path d="M22 10a2 2 0 0 0-2-2h-1v8h1a2 2 0 0 0 2-2Z" />
  </svg>
);

export const TrophyIcon: React.FC<IconProps> = ({ size = 20, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ArrowRightLeftIcon: React.FC<IconProps> = ({ size = 20, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
